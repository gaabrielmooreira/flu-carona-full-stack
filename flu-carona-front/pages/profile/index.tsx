...
export default function Profile() {
  ...
  if (userProfile.id === 0) return (
    <Layout>
      <div className="h-screen w-full flex items-center justify-center">
        <div role="status">
          <svg aria-hidden="true" className="inline w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-flu-red" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
